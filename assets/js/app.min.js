(() => {
      ...
      if (i.length)
        return (
          i.forEach((t) => {
            ...
            l.push({ itemsArray: r, matchMedia: n });
          }),
          l
        );
    }
    ...
    getSelectTitleValue(e, t) {
      ...
      if (
        (t.hasAttribute("data-pseudo-label") &&
          ...
          (l = ` ${this.selectClasses.classSelectPseudoLabel}`)),
        ...
        return `<div class="${this.selectClasses.classSelectTitle}"><span${i} class="${this.selectClasses.classSelectValue}"><input autocomplete="off" type="text" placeholder="${s}" data-placeholder="${s}" class="${this.selectClasses.classSelectInput}"></span></div>`;
      {
        const e =
          ...
          this.getSelectedOptionsData(t).elements[0].dataset.class
            ? ` ${this.getSelectedOptionsData(t).elements[0].dataset.class}`
            : "";
        return `<button type="button" class="${this.selectClasses.classSelectTitle}"><span${i} class="${this.selectClasses.classSelectValue}${l}"><span class="${this.selectClasses.classSelectContent}${e}">${s} <svg width="17" height="13" viewBox="0 0 17 13" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.6709 0.239258C3.97168 -0.0820312 4.44336 -0.0751953 4.74414 0.239258L8.18262 3.75977C8.32617 3.90332 8.4082 4.1084 8.4082 4.29297C8.4082 4.7168 8.11426 5.00391 7.69727 5.00391C7.49902 5.00391 7.32812 4.93555 7.19824 4.79883L5.79004 3.33594L4.86719 2.27637L4.92188 3.73926V12.2842C4.92188 12.708 4.62109 13.0088 4.2041 13.0088C3.78711 13.0088 3.48633 12.708 3.48633 12.2842V3.73926L3.54102 2.27637L2.625 3.33594L1.20996 4.79883C1.08008 4.93555 0.916016 5.00391 0.710938 5.00391C0.293945 5.00391 0 4.7168 0 4.29297C0 4.1084 0.0888672 3.90332 0.225586 3.75977L3.6709 0.239258ZM12.6533 12.7764C12.3525 13.0908 11.8809 13.084 11.5801 12.7764L8.13477 9.24219C7.99805 9.10547 7.91602 8.90039 7.91602 8.71582C7.91602 8.29199 8.20996 8.00488 8.62695 8.00488C8.8252 8.00488 8.98926 8.07324 9.12598 8.20996L10.5342 9.66602L11.4502 10.7324L11.3955 9.26953V0.724609C11.3955 0.307617 11.7031 0 12.1201 0C12.5371 0 12.8379 0.307617 12.8379 0.724609V9.26953L12.7832 10.7324L13.6992 9.66602L15.1074 8.20996C15.2441 8.07324 15.4082 8.00488 15.6133 8.00488C16.0303 8.00488 16.3242 8.29199 16.3242 8.71582C16.3242 8.90039 16.2354 9.10547 16.0986 9.24219L12.6533 12.7764Z" fill="black" /></svg></span></span></button>`;
      }
    }
          ...
          void 0 !== a &&
            ...
            (b(e[l]) && b(i[l])
              ? i[l].__swiper__
                ...
                : y(e[l], i[l])
              : !b(e[l]) && b(i[l])
              ? ((e[l] = {}), i[l].__swiper__ ? (e[l] = i[l]) : y(e[l], i[l]))
              : (e[l] = i[l]));
        }
      }
    }
  ...
  var j = {
    ...
    updateSlides: function () {
      ...
      const s = e.params,
        ...
        c = C(l, `.${e.params.slideClass}, swiper-slide`),
      ...
      "string" == typeof b && b.indexOf("%") >= 0
        ...
        s.centeredSlides &&
          s.cssMode &&
          (E(i, "--swiper-centered-offset-before", ""),
      ...
      for (let i = 0; i < p; i += 1) {
        ...
        if (
          ((L = 0),
          c[i] && (l = c[i]),
          x && e.grid.updateSlide(i, l, c),
          !c[i] || "none" !== M(l, "display"))
        ) {
          if ("auto" === s.slidesPerView) {
            A && (c[i].style[e.getDirectionLabel("width")] = "");
            const a = getComputedStyle(l),
              n = l.style.transform,
              r = l.style.webkitTransform;
            if (
              (n && (l.style.transform = "none"),
              r && (l.style.webkitTransform = "none"),
              s.roundLengths)
            )
              L = e.isHorizontal() ? k(l, "width", !0) : k(l, "height", !0);
            else {
              const e = t(a, "width"),
                s = t(a, "padding-left"),
                i = t(a, "padding-right"),
              ...
              if (o && "border-box" === o) L = e + n + r;
              else {
                const { clientWidth: t, offsetWidth: a } = l;
                L = e + s + i + n + r + (a - t);
              }
            }
            n && (l.style.transform = n),
              r && (l.style.webkitTransform = r),
              s.roundLengths && (L = Math.floor(L));
          } else
            (L = (a - (s.slidesPerView - 1) * b) / s.slidesPerView),
              s.roundLengths && (L = Math.floor(L)),
      ...
      if (
        ...
        x && e.grid.updateWrapperSize(L, u),
        !s.centeredSlides)
      ) {
        const t = [];
      ...
      if (o && s.loop) {
        ...
        if (s.slidesPerGroup > 1) {
          const i = Math.ceil(
            ...
            l = t * s.slidesPerGroup;
          for (let e = 0; e < i; e += 1) u.push(u[u.length - 1] + l);
        }
        for (
          let i = 0;
    ...
    updateSlidesProgress: function (e) {
      ...
      let n = -e;
      l && (n = e), (t.visibleSlidesIndexes = []), (t.visibleSlides = []);
      ...
      for (let e = 0; e < i.length; e += 1) {
        ...
        f && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e)),
          V(o, f, s.slideVisibleClass),
          V(o, m, s.slideFullyVisibleClass),
          (o.progress = l ? -c : c),
    ...
    updateSlidesClasses: function () {
      ...
      if (a)
        ...
        n
          ? ((o = t.filter((e) => e.column === l)[0]),
            (c = t.filter((e) => e.column === l + 1)[0]),
            (d = t.filter((e) => e.column === l - 1)[0]))
          : (o = t[l]);
      o &&
        (n ||
          ((c = (function (e, t) {
  ...
  var R = {
    ...
    setTranslate: function (e, t) {
      ...
      s.isHorizontal() ? (o = i ? -e : e) : (d = e),
        l.roundLengths && ((o = Math.floor(o)), (d = Math.floor(d))),
  ...
  var Y = {
    ...
    slideToLoop: function (e, t, s, i) {
      ...
      const a = l.grid && l.params.grid && l.params.grid.rows > 1;
      let n = e;
      if (l.params.loop)
        if (l.virtual && l.params.virtual.enabled) n += l.virtual.slidesBefore;
          ...
          const t = a
              ...
              : l.slides.length,
            { centeredSlides: s } = l.params;
          let r = l.params.slidesPerView;
          "auto" === r
            ? (r = l.slidesPerViewDynamic())
            : ((r = Math.ceil(parseFloat(l.params.slidesPerView, 10))),
              s && r % 2 == 0 && (r += 1));
          let o = t - e < r;
          if (
            (s && (o = o || e < Math.ceil(r / 2)),
            i && s && "auto" !== l.params.slidesPerView && !a && (o = !1),
            o)
          ) {
            const i = s
              ? e < l.activeIndex
            ...
            l.loopFix({
              ...
              slideRealIndex: "next" === i ? l.realIndex : void 0,
            });
          }
          if (a) {
            const e = n * l.params.grid.rows;
            n = l.slides.filter(
    ...
    slidePrev: function (e, t, s) {
      ...
      void 0 === e && (e = i.params.speed);
      const c = i.virtual && l.virtual.enabled;
      if (l.loop) {
        ...
        (l = parseInt(
          ...
          t.centeredSlides
            ? a < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (a = e.getSlideIndex(
                  C(s, `${n}[data-swiper-slide-index="${l}"]`)[0]
                )),
                g(() => {
                  e.slideTo(a);
                }))
  ...
  var X = {
    ...
    loopFix: function (e) {
      ...
      const M = S ? Math.ceil(d.length / h.grid.rows) : d.length,
        A = (S ? d[a].column : a) + (m && void 0 === l ? -f / 2 + 0.5 : 0);
      if (A < v) {
        C = Math.max(v - A, g);
  ...
  function Z(e) {
    ...
    if ("pointerdown" === i.type) {
      if (null !== l.pointerId && l.pointerId !== i.pointerId) return;
      l.pointerId = i.pointerId;
    } else
      "touchstart" === i.type &&
        1 === i.targetTouches.length &&
        (l.touchId = i.targetTouches[0].identifier);
    ...
    o.matches(l.focusableElements) &&
      ((S = !1), "SELECT" === o.nodeName && (l.isTouched = !1)),
      s.activeElement &&
        s.activeElement.matches(l.focusableElements) &&
        s.activeElement !== o &&
        s.activeElement.blur();
    const b = S && t.allowTouchMove && a.touchStartPreventDefault;
  ...
  function Q(e) {
    ...
    (s.allowClick = !1),
      !l.cssMode && d.cancelable && d.preventDefault(),
      l.touchMoveStopPropagation && !l.nested && d.stopPropagation();
          ...
          i.currentTranslate > s.minTranslate() &&
            ...
            l.resistance &&
              (i.currentTranslate =
                s.minTranslate() -
                1 +
                (-s.minTranslate() + i.startTranslate + f) ** E)))
        : f < 0 &&
          (b &&
            w &&
            i.allowThresholdMove &&
          ...
          i.currentTranslate < s.maxTranslate() &&
            ...
            l.resistance &&
              (i.currentTranslate =
                s.maxTranslate() +
                1 -
                (s.maxTranslate() - i.startTranslate - f) ** E))),
  ...
  function K(e) {
    ...
    if ("touchend" === l.type || "touchcancel" === l.type) {
      if (
        ((i = [...l.changedTouches].filter(
      ...
      if (l.pointerId !== s.pointerId) return;
      i = l;
    }
    if (
    ...
    if (!d) return;
    if (!a.simulateTouch && "mouse" === l.pointerType) return;
    if (
    ...
    if (t.allowClick) {
      ...
      t.updateClickedSlide((e && e[0]) || l.target, e),
        t.emit("tap click", l),
        p < 300 &&
    ...
    if (p > a.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (w >= a.longSwipesRatio
          ? t.slideTo(a.rewind && t.isEnd ? S : m + y)
          : t.slideTo(m)),
      ...
      (l.target === t.navigation.nextEl || l.target === t.navigation.prevEl)
        ? l.target === t.navigation.nextEl
          ? t.slideTo(m + y)
          : t.slideTo(m)
        : ("next" === t.swipeDirection && t.slideTo(null !== S ? S : m + y),
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const h = r.direction && r.direction !== i.direction,
            m = i.loop && (r.slidesPerView !== i.slidesPerView || h),
            f = i.loop;
          h && s && e.changeDirection(), y(e.params, r);
    ...
    return (
      e.params.createElements &&
        Object.keys(i).forEach((l) => {
          if (!s[l] && !0 === s.auto) {
            let a = C(e.el, `.${i[l]}`)[0];
            a || ((a = L("div", i[l])), (a.className = i[l]), e.el.append(a)),
              (s[l] = a),
              (t[l] = a);
          }
        }),
      ...
      i("click", (e, s) => {
        ...
        if (
          ...
          i.length
            ...
            l(!0 === e ? "navigationShow" : "navigationHide"),
            [...i, ...a]
              .filter((e) => !!e)
              .forEach((e) =>
  ...
  function me(e) {
    ...
    function p() {
      ...
      if (
        ...
        if (
          (s.dynamicBullets &&
            ((n = k(l[0], t.isHorizontal() ? "width" : "height", !0)),
            c.forEach((e) => {
            ...
            s.dynamicMainBullets > 1 &&
              ...
              r > s.dynamicMainBullets - 1
                ...
                : r < 0 && (r = 0)),
            (o = Math.max(i - r, 0)),
            (p = o + (Math.min(l.length, s.dynamicMainBullets) - 1)),
            (u = (p + o) / 2)),
          l.forEach((e) => {
            const t = [
              ...[
  ...
  Object.keys(oe).forEach((e) => {
    ...
    window.addEventListener("load", function (e) {
      document.querySelector(".swiper-product") &&
        new ce(".swiper-product", {
          modules: [ue, me],
          observer: !0,
          observeParents: !0,
          slidesPerView: 1,
  ...
  new ge("max").init(),
    document.querySelector(".icon-sidebar") &&
      document.addEventListener("click", function (e) {
        e.target.closest(".icon-sidebar")
          ? (a(), document.documentElement.classList.toggle("sidebar-open"))
          : !document.documentElement.classList.contains("sidebar-open") ||
            e.target.closest(".sidebar") ||
            e.target.closest(".icon-sidebar") ||
            (a(), document.documentElement.classList.remove("sidebar-open"));
      }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
        ...
        function r(e) {
          ...
          if (t.closest("[data-spoller]")) {
            const s = t.closest("[data-spoller]"),
              ...
              n = l.dataset.spollersSpeed
                ? parseInt(l.dataset.spollersSpeed)
                : 500;
            l.querySelectorAll("._slide").length ||
              (a && !s.classList.contains("_spoller-active") && d(l),
