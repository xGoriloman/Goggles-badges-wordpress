(() => {
  ...
  function formQuantity() {
    document.addEventListener("click", function (e) {
      ...
      if (targetElement.closest(".quantity__button")) {
        ...
        if (targetElement.classList.contains("quantity__button_plus")) value++;
        else {
          --value;
          if (value < 1) value = 1;
        }
  ...
  function initSliders() {
    if (document.querySelector(".swiper-product"))
      new swiper_core_Swiper(".swiper-product", {
  ...
  da.init();
  if (document.querySelector(".icon-sidebar-filter"))
    document.addEventListener("click", function (e) {
      if (e.target.closest(".icon-sidebar-filter")) {
        bodyLockToggle();
        document.documentElement.classList.toggle("sidebar-filter-open");
      } else if (
        document.documentElement.classList.contains("sidebar-filter-open") &&
        !e.target.closest(".sidebar") &&
        !e.target.closest(".icon-sidebar-filter")
      ) {
        bodyLockToggle();
  ...
  if (document.querySelector(".icon-sidebar-sort"))
    document.addEventListener("click", function (e) {
      if (e.target.closest(".icon-sidebar-sort")) {
        bodyLockToggle();
        document.documentElement.classList.toggle("sidebar-sort-open");
      } else if (
        document.documentElement.classList.contains("sidebar-sort-open") &&
        !e.target.closest(".sidebar") &&
        !e.target.closest(".icon-sort-filter")
      ) {
        bodyLockToggle();
        document.documentElement.classList.remove("sidebar-sort-open");
      }
    });
  window["FLS"] = true;
  isWebp();
