...
<div class="profile-favorites">
    <div class="profile-favorites__header">
        <h2 class="profile-favorites__title">Избранное</h2>
    </div>
                    ...
                    if ($product && $product->is_visible()) : ?>
                        <div class="card">
                            ...
                            <div class="card__conten">
                                <p class="card__article">Арт <?php echo $product->get_sku() ?: $product_id; ?></p>
                                ...
                                <div class="card__prices">
                                    <?php if ($product->is_on_sale()) : ?>
                                        <div class="card__price card__new-price"><?php echo $product->get_sale_price(); ?> ₽</div>
                                        <div class="card__price card__old-price"><?php echo $product->get_regular_price(); ?> ₽</div>
                                    <?php else : ?>
                                        <div class="card__price card__new-price"><?php echo $product->get_price(); ?> ₽</div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <?php else : ?>
                                    <div class="card__button button-black disabled">Нет в наличии</div>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endif; ?>
